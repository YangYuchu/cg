...
char bunny_string[] = "bunny.obj";
char bunny_smooth_string[] = "bunny_smooth.obj";
char teapot_string[] = "teapot.obj";
char sponze_string[] = "sponza.obj";
...
makeTeapotScene()
{
	...
	teapot->load(teapot_string);
	addMeshTrianglesToScene(teapot, material);//这是g_scene真正载入obj文件的时候
...
makeSmoothBunny1Scene()
{
	...
	TriangleMesh* bunny = new TriangleMesh;
	char bunny_smooth_string[] = "bunny_smooth.obj";
	bunny->load(bunny_smooth_string);
	addMeshTrianglesToScene(bunny, material);
...
makeSmoothBunny20Scene()
{
	...
	xform *= rotate(25, .3, .1, .6);
	mesh = new TriangleMesh;
	mesh->load(bunny_smooth_string, xform);
	addMeshTrianglesToScene(mesh, material);
